...
'''
Change IC pins to lower down inductance
Add VRM: R=3 mOhm and L=2.5nH 
Board thickness: 1mm ~ 5mm ...
Number of layers: 4 ~ 8 ...
Locations: 22, in which 1 is for IC and 1 is for VRM; 20 for decaps
Via distance: 1mm ...
'''
...
# I changed n from 8 to 4 here
def gen_random_brd_shape(max_len, img_size, num_locations, n=4, thre_angle=30,
    ...
    while num_available_locations < num_locations:
        ...
        while angle < 30:
            ...
            #a = np.array([[100e-3, 500e-3], [500e-3, 100e-3], [900e-3, 500e-3], [500e-3,900e-3]])
...
def gen_brd_data(brd, max_len, img_size, num_locations=102, n=8, thre_angle=30, rad=0.1, edgy=0.05,
                 num_pts=10, min_t=1e-3, max_t=2e-3, min_dt=0.1e-3, min_n_layer=4, max_n_layer=7,
                 er=4.4, via_dist=1e-3, vrm_r=3e-3, vrm_l=2.5e-9):
    ...
    # create ic pins
    d = 1e-3
    brd.ic_via_xy = np.zeros((21,2))
    # Pwr pins
    brd.ic_via_xy[0,0] = ic_x_indx * unit_size - d
    brd.ic_via_xy[0,1] = ic_y_indx * unit_size + d
    brd.ic_via_xy[1,0] = ic_x_indx * unit_size
    brd.ic_via_xy[1,1] = ic_y_indx * unit_size + d
    brd.ic_via_xy[2,0] = ic_x_indx * unit_size + d
    brd.ic_via_xy[2,1] = ic_y_indx * unit_size + d
    brd.ic_via_xy[3,0] = ic_x_indx * unit_size - d
    brd.ic_via_xy[3,1] = ic_y_indx * unit_size
    brd.ic_via_xy[4,0] = ic_x_indx * unit_size
    brd.ic_via_xy[4,1] = ic_y_indx * unit_size
    brd.ic_via_xy[5,0] = ic_x_indx * unit_size + d
    brd.ic_via_xy[5,1] = ic_y_indx * unit_size
    brd.ic_via_xy[6,0] = ic_x_indx * unit_size - d
    brd.ic_via_xy[6,1] = ic_y_indx * unit_size - d
    brd.ic_via_xy[7,0] = ic_x_indx * unit_size
    brd.ic_via_xy[7,1] = ic_y_indx * unit_size - d
    brd.ic_via_xy[8,0] = ic_x_indx * unit_size + d
    brd.ic_via_xy[8,1] = ic_y_indx * unit_size - d
    
    brd.ic_via_xy[9,0] = ic_x_indx * unit_size - d
    brd.ic_via_xy[9,1] = ic_y_indx * unit_size + d * 2
    brd.ic_via_xy[10,0] = ic_x_indx * unit_size
    brd.ic_via_xy[10,1] = ic_y_indx * unit_size + d * 2
    brd.ic_via_xy[11,0] = ic_x_indx * unit_size + d
    brd.ic_via_xy[11,1] = ic_y_indx * unit_size + d * 2
    brd.ic_via_xy[12,0] = ic_x_indx * unit_size - d
    brd.ic_via_xy[12,1] = ic_y_indx * unit_size - d * 2
    brd.ic_via_xy[13,0] = ic_x_indx * unit_size
    brd.ic_via_xy[13,1] = ic_y_indx * unit_size - d * 2
    brd.ic_via_xy[14,0] = ic_x_indx * unit_size + d
    brd.ic_via_xy[14,1] = ic_y_indx * unit_size - d * 2
    brd.ic_via_xy[15,0] = ic_x_indx * unit_size - d * 2
    brd.ic_via_xy[15,1] = ic_y_indx * unit_size + d
    brd.ic_via_xy[16,0] = ic_x_indx * unit_size - d * 2
    brd.ic_via_xy[16,1] = ic_y_indx * unit_size
    brd.ic_via_xy[17,0] = ic_x_indx * unit_size - d * 2
    brd.ic_via_xy[17,1] = ic_y_indx * unit_size - d
    brd.ic_via_xy[18,0] = ic_x_indx * unit_size + d * 2
    brd.ic_via_xy[18,1] = ic_y_indx * unit_size + d
    brd.ic_via_xy[19,0] = ic_x_indx * unit_size + d * 2
    brd.ic_via_xy[19,1] = ic_y_indx * unit_size
    brd.ic_via_xy[20,0] = ic_x_indx * unit_size + d * 2
    brd.ic_via_xy[20,1] = ic_y_indx * unit_size - d
